...
# On lance le simulateur de lien avec 40% de pertes et un délais de 1500ms avec un jiiter de 350, corruption de 5%
./link_sim -p 1341 -P 2456 -l 40 -d 2000 -j 350 -e 5 -R  &> link.log &
link_pid=$!
